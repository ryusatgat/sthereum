...
task("check", "checkt contact amounts", async () => {
  const [deployers, next] = await ethers.getSigners();
  ...
  console.log( await sc.name());
  console.log( await sc.symbol());
  console.log(deployers.address);
  console.log(next.address);
  console.log(await sc.balanceOf(deployers.address));
